    ...
    <div class="card-group">
        <div class="card" style="width: 18rem;">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><?php echo $section->en_title;  ?></li>
                <li class="list-group-item"><?php echo $section->en_text; ?></li>
            </ul>
        </div>
        <div class="card" style="width: 18rem;">
            <div class="card-header">
                Section Georgian Description
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><?php echo $section->ge_title;?></li>
                <li class="list-group-item"><?php echo $section->ge_text;?></li>
            </ul>
        </div>
        <div class="card" style="width: 18rem;">
            <div class="card-header">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><?php echo $section->ru_title; ?></li>
                <li class="list-group-item"><?php echo $section->ru_text ;?></li>
            </ul>
        </div>
    </div>

    <a href="<?php echo URLROOT_ADMIN; ?>/Section_admins/editSection/<?php echo $section->id;?>" type="button" class="btn btn-secondary">Edit</a>

    <form action="<?php echo URLROOT; ?>/Section_admins/deleteSection/<?php echo $section->id;?>" method="POST">
